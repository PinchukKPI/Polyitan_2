...
%
X_input = PN_massive(4)/1000; % км
Y_input = PN_massive(5)/1000; % км
Z_input = PN_massive(6)/1000; % км
% 
VX_input = PN_massive(1)/1000; % км/сек
VY_input = PN_massive(2)/1000; % км/сек
VZ_input = PN_massive(3)/1000; % км/сек
%--------------------------------------------------------------------------
%-------- Входные параметры -----------------------------------------------
%--------------------------------------------------------------------------
print_orbit = 2; %!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
